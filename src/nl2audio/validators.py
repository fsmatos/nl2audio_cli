...
def check_gmail_oauth(cfg: AppConfig) -> CheckResult:
    ...
    try:
        from .gmail_oauth import get_stored_credentials, build_gmail_service, get_label_id
...
def validate_runtime(cfg: AppConfig, *, check_openai: bool = False, check_gmail: bool = False) -> List[CheckResult]:
