...
from nl2audio.validators import (
    check_output_dir, check_ffmpeg, check_openai_key,
    check_openai_probe, check_gmail_oauth, check_gmail_imap,
    validate_config, validate_runtime, get_check_summary
)
...
class TestConfigValidation:
    ...
    def test_validate_runtime_with_openai_probe(self, sample_config, mock_ffmpeg, mock_env_vars, mock_openai_client):
...
class TestCheckSummary:
    ...
    def test_get_check_summary(self, sample_config, mock_ffmpeg, mock_env_vars):
        ...
        assert summary["total"] == summary["passed"] + summary["warnings"] + summary["failed"] 